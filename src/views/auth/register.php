            ...
            <div class="row justify-content-center">
                <div class="col-12 col-sm-10 col-md-8 col-lg-7 col-xl-5">
                    ...
                    <?php if (isset($_GET['error']) && $_GET['error'] === 'email_exists'): ?>
                        <div class="alert alert-danger alert-dismissible fade show text-center fw-bold shadow-sm mb-3 rounded-3" role="alert">
                            <i class="bi bi-exclamation-triangle-fill me-2"></i>
                            هذا البريد الإلكتروني مسجل بالفعل بالنظام!
                    ...
                    <?php if (isset($_GET['error']) && $_GET['error'] === 'failed'): ?>
                        <div class="alert alert-danger alert-dismissible fade show text-center fw-bold shadow-sm mb-3 rounded-3" role="alert">
                            ...
                            حدث خطأ أثناء معالجة طلبك، يرجى إعادة المحاولة لاحقاً.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    <?php endif; ?>
                    <div class="card login-card shadow-lg">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form action="/register_process" method="POST" id="mainRegisterForm">
                                <div class="mb-3">
                                ...
                                <div class="text-center pt-3 border-top border-white-20 mt-3">
                                    ...
                                    <a href="/login" class="text-white fw-bold text-decoration-none small ms-1">تسجيل الدخول</a>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        ...
        function saveExtraData(role) {
            ...
            if (role === 'student') {
                ...
                if (!isTraining && !isVolunteering) { alert("يرجى اختيار تخصص واحد على الأقل!"); return; }
