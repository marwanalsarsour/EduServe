...
<head>
    ...
    <title>الملف الشخصي - مشرف التطوع الأكاديمي</title>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 text-center p-4 h-100">
                    ...
                    <h5 class="fw-bold text-dark mb-1">أ. مشرف التطوع</h5>
                        ...
                        <form action="update_profile.php" method="POST">
                            <div class="row g-4">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control bg-light border-0 py-2 shadow-sm" value="الاسم هنا" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="small fw-bold text-secondary mb-2">البريد الجامعي</label>
                                    <input type="email" class="form-control bg-light border-0 py-2 shadow-sm" value="volunteer@ppu.edu" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="small fw-bold text-secondary mb-2">هاتف التواصل</label>
                                    <input type="text" class="form-control bg-light border-0 py-2 shadow-sm" value="0222XXXX">
                                </div>
                            </div>
