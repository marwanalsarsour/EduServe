                    ...
                    <div class="card-body p-4">
                        <form action="/trainer/profile/update" method="POST">
                            ...
                            <div class="text-start mt-4">
                                <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold shadow-sm">حفظ البيانات</button>
                            </div>
                        </form>
                    </div>
                </div>

                <div class="card border-0 shadow-sm rounded-4 border-right-info">
                    <div class="card-header bg-white border-0 pt-4 px-4">
                        <h6 class="fw-bold mb-0 text-dark"><i class="bi bi-key ms-2 text-info"></i>تحديث كلمة المرور</h6>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form action="/trainer/profile/update-password" method="POST">
                            ...
                            <div class="text-start mt-4">
                                <button type="submit" class="btn btn-outline-info rounded-pill px-4 fw-bold shadow-sm">تحديث كلمة السر</button>
                            </div>
                        </form>
                    </div>
                </div>
