    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-4 text-center p-4 h-100">
                ...
                <h5 class="fw-bold text-dark mb-1"><?= htmlspecialchars($profile['employeeName'] ?? '') ?></h5>
                ...
                <div class="bg-white border rounded-3 p-3 mt-3 text-end shadow-sm">
                    <div class="mb-2 border-bottom pb-2">
                        ...
                        <span class="fw-bold text-dark"><?= htmlspecialchars($profile['entityName'] ?? '') ?></span>
                    </div>
                    <div class="mb-0 pt-1">
                        <small class="text-secondary d-block">موقع المؤسسة:</small>
                        <span class="fw-bold text-dark"><?= htmlspecialchars($profile['location'] ?? '') ?></span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form action="/v_manager/profile/update" method="POST">
                        <div class="row g-4">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="employeeName" class="form-control bg-light border-0 py-2 shadow-sm" value="<?= htmlspecialchars($profile['employeeName'] ?? '') ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="small fw-bold text-secondary mb-2">البريد الإلكتروني</label>
                                <input type="email" name="employeeEmail" class="form-control bg-light border-0 py-2 shadow-sm" value="<?= htmlspecialchars($profile['employeeEmail'] ?? '') ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="small fw-bold text-secondary mb-2">موقع المؤسسة</label>
                                <input type="text" name="location" class="form-control bg-light border-0 py-2 shadow-sm" value="<?= htmlspecialchars($profile['location'] ?? '') ?>" required>
                            </div>
                        </div>
