                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4">
                        ...
                        <div class="alert alert-info py-2 small border-0 text-center mb-4">
                            الطالب: 
                            <strong>
                                <?= htmlspecialchars($data['student']['name'] ?? 'غير معروف') ?>
                            </strong>
                        </div>

                        <form method="POST"
                              action="/submit_save_evaluation_process"
                              autocomplete="off">

                            <!-- مهم: studentID الصحيح -->
                            <input type="hidden" name="student_id"
                                   value="<?= htmlspecialchars($data['student']['studentID'] ?? '') ?>">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="notes"
                                          class="form-control"
                                          rows="4"
                                          placeholder="أدخل أي ملاحظات حول أداء الطالب خلال فترة التدريب..."></textarea>
                            </div>
