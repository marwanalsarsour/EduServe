...
<head>
    ...
    <title>الملف الشخصي - مشرف التدريب الأكاديمي</title>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 text-center p-4 h-100">
                    ...
                    <h5 class="fw-bold text-dark mb-1">د. مروان Sarsour</h5>
                    ...
                    <div class="bg-white border rounded-3 p-3 mt-3 text-end shadow-sm">
                        <div class="mb-2 border-bottom pb-2">
                            ...
                            <span class="fw-bold text-dark">تكنولوجيا المعلومات وهندسة الحاسوب</span>
                        </div>
                        <div class="mb-0 pt-1">
                        ...
                        <form action="update_profile.php" method="POST">
                            <div class="row g-4">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control bg-light border-0 py-2 shadow-sm" value="مروان Sarsour" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="small fw-bold text-secondary mb-2">البريد الإلكتروني الجامعي</label>
                                    <input type="email" class="form-control bg-light border-0 py-2 shadow-sm" value="m.sarsour@ppu.edu" required>
                                </div>
                                <div class="col-md-6">
